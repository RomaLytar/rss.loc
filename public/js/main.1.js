...
$('.sizeTabs select').on('change', function () {
...

{
  ...
  configTabs.forEach(e => e.addEventListener('mouseup', function () {
    ...
    $('#twoDoors').attr('data-src', this.getAttribute('data-image-two'))
    $('#threeDoors').attr('data-src', this.getAttribute('data-image-three'))
  ...
  function changeCommonPrice() {
    ...
    target.text(`${commonPrice + parseInt(target.attr('data-color1-price')) + parseInt(target.attr('data-color2-price')) + parseInt(target.attr('data-fasad-color-price')) + parseInt(target.attr('data-addEquip-price')) + parseInt(target.attr('data-size-price'))} грн.`);
  }
